...
export async function GET(request: NextRequest) {
    ...
    if (error) {
        return NextResponse.redirect(new URL('/dashboard/plugins?error=jira_auth_failed', origin))
    }
    ...
    try {
        ...
        // Success!
        return NextResponse.redirect(new URL('/dashboard/plugins?success=jira_connected', origin))
